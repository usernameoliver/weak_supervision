...
def train_model(model, model_name, criterion, optimizer, scheduler, num_epochs, data_dir, subset, flipped_label_dict):
    ...
    state_save_path = base_path + model_name +  'bc_state.pt'
    entire_model_save_path = base_path + model_name + 'bc_entire_model.pt'
    check_point_save_path = base_path + model_name + 'bc_checkpoint_model.pt'
